<template>
        ...
        <template v-slot:0><p>Some content not a component! 🥳 The next two tabs are components with their data passed in. </p></template> 
        ...
        <prism language="javascript">data() {
        return {
        ...
        <h3 class="italic title--page">
           Inside TabSwitch component - template
        </h3>
        <prism language="javascript">{{two}}</prism>
        <p class="strong italic">what is happening inside this template: </p>
        <ul class="list list--bullet">
            <li>
                A loop from the tabs data - creates each tab item.
            </li>
            <li>
                A method toggleTab gets the current index when clicked - which set the current data to match the index.
            </li>
            <li>
                An active class based on the current index and clicked tab - if a match active class is added.
            </li>
            <li>
                A loop based on the number of tabs - passing in the index to the slot name.
            </li>
            <li>
                An if statement to display the tab matching the current tab clicked.
            </li>
        </ul>
          <h3 class="italic title--page">
           Inside TabSwitch component - script
        </h3>
        <prism language="javascript">{{three}}</prism>
        <p class="strong italic">what is happening inside this script: </p>
        <ul class="list list--bullet">
            <li>
                props are set for the tabs array
            </li>
            <li>
                current is set to 0 - being the first tab
            </li>
            <li>
                toggleTab method takes the index and sets the current data - which updates to display active and the matching tab.
            </li>
        </ul>
        ...
        <p>
            That's the complete code to create tabs using named slots. 😁
        </p>
    </div>
</template>
